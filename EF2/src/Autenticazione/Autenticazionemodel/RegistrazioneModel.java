...
public class RegistrazioneModel {
	...
	private static final Pattern SPECIALCHAR_PATTERN = Pattern.compile(".*[!=$%@#^&*()-+?<>].*");// almeno un carattere
																									// speciale
	private static final Pattern NUMBER_PATTERN = Pattern.compile(".*[1-9].*"); // almeno un numero
	private static final Pattern EMAIL_PATTERN = Pattern
			.compile("^[_A-Za-z0-9-]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$"); // pattern
																												// per
																												// la
																												// mail
	...
	public void impostaUtente(String nome, String emailutente, String password) {
		// SingletonGestione.getInstance().setUtente(new UtenteAutenticato(nome,
		// emailutente, password));
	...
	// metodo che verifica se i dati inseriti sono corretti, esso restituisce un
	// intero in funzione dell'errore presente
	public int validaDati(String nome, String cognome, String username, String email, char[] passwordChars1,
			char[] passwordChars2) {
